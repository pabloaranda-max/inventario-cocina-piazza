# inventario.html — Especificación técnica v4.13
...
| R16 | **Guardas de subida de plantilla** — la pestaña Plantillas aceptaba cualquier xlsx para cualquier almacén. Ahora rechaza los exports que genera la propia app (metadato `Application: SheetJS`, o columna Cantidad con valores; Xetux escribe `Apache POI` y la deja vacía) y avisa cuando los códigos entrantes casi no coinciden con los que el almacén ya tiene. Ver incidente 2026-07-27 | HECHO — **EN PROD 2026-07-28** (main `469e7a7`). Validado contra los archivos reales del incidente: plantillas de SALUMERÍA y CAVA pasan, el export de CAVA se bloquea, cruce de códigos 100% contra el almacén correcto y 0% contra el equivocado |
